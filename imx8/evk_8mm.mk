...
ifneq ($(wildcard device/fsl/evk_8mm/fstab.freescale),)
$(shell touch device/fsl/evk_8mm/fstab.freescale)
endif
...
PRODUCT_COPY_FILES += \
	device/fsl/evk_8mm/init.rc:root/init.freescale.rc \
...
PRODUCT_COPY_FILES += \
	device/fsl/evk_8mm/audio_effects.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects.conf \
	device/fsl/evk_8mm/audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.xml \
...
PRODUCT_COPY_FILES += \
    device/fsl/evk_8mm/init.freescale.sd.rc:root/init.freescale.sd.rc \
    device/fsl/evk_8mm/init.freescale.sd.rc:root/init.recovery.freescale.sd.rc \
    device/fsl/evk_8mm/init.freescale.emmc.rc:root/init.freescale.emmc.rc \
    device/fsl/evk_8mm/init.freescale.emmc.rc:root/init.recovery.freescale.emmc.rc

DEVICE_PACKAGE_OVERLAYS := device/fsl/evk_8mm/overlay
