...
BOARD_MKBOOTIMG_ARGS = --second $(PRODUCT_OUT)/kernel.dtb --base $(BOARD_KERNEL_BASE) --second_offset $(BOARD_SECOND_OFFSET) --kernel_offset $(BOARD_KERNEL_OFFSET) --ramdisk_offset $(BOARD_RAMDISK_OFFSET)
