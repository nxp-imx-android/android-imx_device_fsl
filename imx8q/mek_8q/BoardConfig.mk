...
ifeq ($(PRODUCT_IMX_CAR),true)
BOARD_KERNEL_CMDLINE := init=/init consoleblank=0 androidboot.hardware=freescale androidboot.fbTileSupport=enable cma=800M@0x960M-0xe00M galcore.contiguousSize=33554432 androidboot.primary_display=imx-drm firmware_class.path=/vendor/firmware transparent_hugepage=never
else
