...
ifeq ($(PRODUCT_IMX_CAR),true)
BOARD_KERNEL_CMDLINE := init=/init consoleblank=0 androidboot.hardware=freescale androidboot.fbTileSupport=enable cma=928M@0x960M-0xe00M androidboot.primary_display=imx-drm firmware_class.path=/vendor/firmware
else
BOARD_KERNEL_CMDLINE := init=/init androidboot.console=ttyLP0 consoleblank=0 androidboot.hardware=freescale androidboot.fbTileSupport=enable cma=928M@0x960M-0xe00M androidboot.primary_display=imx-drm firmware_class.path=/vendor/firmware
endif
...
TARGET_BOOTLOADER_CONFIG := imx8qm:imx8qm_mek_androidauto_trusty_defconfig imx8qm-xen:imx8qm_mek_androidauto_xen_defconfig imx8qm-a0:imx8qm_mek_androidauto_defconfig imx8qxp:imx8qxp_mek_androidauto_trusty_defconfig
else
...
TARGET_BOOTLOADER_CONFIG := imx8qm:imx8qm_mek_android_defconfig imx8qm-a0:imx8qm_mek_android_defconfig imx8qxp:imx8qxp_mek_android_defconfig
endif #PRODUCT_IMX_CAR
