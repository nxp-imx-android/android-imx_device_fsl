...
UBOOT_OUT := $(TARGET_OUT_INTERMEDIATES)/BOOTLOADER_OBJ
...
define build_uboot
	...
	cp $(FSL_PROPRIETARY_PATH)/fsl-proprietary/uboot-firmware/imx8m/bl31-imx8mq.bin $(IMX_MKIMAGE_PATH)/imx-mkimage/iMX8M/bl31.bin; \
