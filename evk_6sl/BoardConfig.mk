...
DEVICE_MANIFEST_FILE := device/fsl/evk_6sl/manifest.xml
DEVICE_MATRIX_FILE := device/fsl/evk_6sl/compatibility_matrix.xml
...
PRODUCT_COPY_FILES += \
       device/fsl/evk_6sl/app_whitelist.xml:system/etc/sysconfig/app_whitelist.xml
