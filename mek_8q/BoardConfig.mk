...
-include external/fsl-restricted-codec/imx_hifi4_aacp_dec/imx_hifi4_aacp_dec.mk
-include external/fsl-restricted-codec/imx_hifi4_dec/imx_hifi4_dec.mk
endif
...
BOARD_KERNEL_CMDLINE := console=ttyLP0,115200 earlycon=lpuart32,0x5a060000,115200,115200 init=/init video=imxdpufb1:off video=imxdpufb2:off video=imxdpufb3:off video=imxdpufb4:off androidboot.console=ttyLP0 consoleblank=0 androidboot.hardware=freescale cma=800M
...
TARGET_BOARD_DTS_CONFIG := imx8qm:fsl-imx8qm-mek-it6263.dtb imx8qxp:fsl-imx8qxp-mek-lvds0-lvds1-it6263.dtb
