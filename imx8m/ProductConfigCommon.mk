...
ifneq ($(PRODUCT_IMX_CAR),true)
PRODUCT_COPY_FILES += device/fsl/imx8m/init.recovery.freescale.rc:root/init.recovery.freescale.rc
else
PRODUCT_COPY_FILES += device/fsl/imx8m/init.recovery.freescale.car.rc:root/init.recovery.freescale.rc
endif
