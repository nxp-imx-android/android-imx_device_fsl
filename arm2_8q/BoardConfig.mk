...
KERNEL_NAME := Image
BOARD_KERNEL_CMDLINE := console=ttyLP0,115200 earlycon=lpuart32,0x5a060000,115200,115200 init=/init androidboot.console=ttyLP0 consoleblank=0 androidboot.hardware=freescale cma=736M@0x960M-0xc40M androidboot.primary_display=imx-drm
...
TARGET_BOOTLOADER_CONFIG := imx8qm:imx8qm_lpddr4_arm2_android_defconfig imx8qxp:imx8qxp_lpddr4_arm2_android_defconfig
