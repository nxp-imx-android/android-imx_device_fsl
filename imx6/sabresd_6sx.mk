...
PRODUCT_COPY_FILES += \
	device/fsl/sabresd_6sx/audio_effects.conf:vendor/etc/audio_effects.conf \
	device/fsl/sabresd_6sx/audio_policy_configuration.xml:system/etc/audio_policy_configuration.xml \
